  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8'>
      ...
      <div className='prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert max-w-none'>
        <p>
          These terms and conditions apply to the ShiftTrack web application
          (hereby referred to as &quot;Application&quot;) accessible via web
          browsers, that was created by Justin Daludado (hereby referred to as
          &quot;Service Provider&quot;) as a Free service.
        </p>
        <br />
        <p>
          By accessing or utilizing the Application, you are automatically
          agreeing to the following terms. It is strongly advised that you
          thoroughly read and understand these terms prior to using the
          Application. Unauthorized copying, modification of the Application,
          any part of the Application, or our trademarks is strictly prohibited.
          Any attempts to reverse engineer, decompile, extract the source code
          of the Application, translate the Application into other languages, or
        ...
        <br />
        <p>
          The Service Provider is not responsible for the way you use the
          Application except as explicitly stated in these terms. You are
          responsible for ensuring the accuracy of any information you input
          into the Application, such as availability or shift details or any
        ...
        <p>
          ...
          by posting the new Terms and Conditions on this page. Changes are
          effective immediately after they are posted on this page.
        </p>
        <br />
        <p className='mt-6'>
          These terms and conditions are effective as of 2025-05-05{' '}
        </p>
        <br />
        <h2 className='text-2xl font-semibold mt-6 mb-3'>
        ...
        <br />
        <h2 className='text-2xl font-semibold mt-6 mb-3'>Privacy Policy</h2>
        <p>
          Your privacy is important to us. Our collection and use of personal
          information in connection with the Application is described in our
